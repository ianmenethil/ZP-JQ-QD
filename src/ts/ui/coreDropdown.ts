...
// /**
//  * Create a standard dropdown button with chevron icon
//  * This is a helper to generate the HTML structure needed for the dropdown button
//  *
//  * @example
//  * ```typescript
//  * const button = createDropdownButton('userModeButton', 'Select Mode', 'Customer Facing');
//  * document.getElementById('container').appendChild(button);
//  * ```
//  */
// export function createDropdownButton(id: string, label: string, initialText: string): HTMLElement {
...
// 			<span data-dropdown-text>${initialText}</span>
...
//  * This is a helper to generate the HTML structure needed for the dropdown container
//  *
//  * @example
//  * ```typescript
//  * const container = createDropdownContainer('userModeDropdown');
//  * document.getElementById('wrapper').appendChild(container);
//  * ```
//  */
// export function createDropdownContainer(id: string): HTMLElement {
// 	const container = document.createElement('div');
// 	container.id = id;
// 	container.className = 'core-dropdown-content';
// 	return container;
// }
